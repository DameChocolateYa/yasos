...
extern "C" double pow(double base, int exponent) {
    double result = 1.0;
    int i;
...
extern "C" double round(double num, int decimals) {
...
extern "C" double ceil(double num) {
...
extern "C" double log(double x, double base) {
